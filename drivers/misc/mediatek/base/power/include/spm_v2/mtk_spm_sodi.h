...
#define sodi_err(fmt, args...)     pr_debug(SODI_TAG fmt, ##args)
#define sodi_warn(fmt, args...)    pr_debug(SODI_TAG fmt, ##args)
#define sodi_debug(fmt, args...)   pr_debug(SODI_TAG fmt, ##args)
#define sodi3_err(fmt, args...)	   pr_debug(SODI3_TAG fmt, ##args)
#define sodi3_warn(fmt, args...)   pr_debug(SODI3_TAG fmt, ##args)
#define sodi3_debug(fmt, args...)  pr_debug(SODI3_TAG fmt, ##args)
#define so_err(fg, fmt, args...)   ((fg&SODI_FLAG_3P0)?pr_debug(SODI3_TAG fmt, ##args):pr_debug(SODI_TAG fmt, ##args))
#define so_warn(fg, fmt, args...)  ((fg&SODI_FLAG_3P0)?pr_debug(SODI3_TAG fmt, ##args):pr_debug(SODI_TAG fmt, ##args))
